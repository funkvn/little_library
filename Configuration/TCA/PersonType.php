...
$GLOBALS['TCA']['tx_littlelibrary_domain_model_person_type'] = array(
	'ctrl' => $GLOBALS['TCA']['tx_littlelibrary_domain_model_person_type']['ctrl'],
	'interface' => array(
	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_littlelibrary_domain_model_person_type.pid=###CURRENT_PID### AND tx_littlelibrary_domain_model_person_type.sys_language_uid IN (-1,0)',
			),
		),
		...
		'name' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:little_library/Resources/Private/Language/locallang.xlf:tx_littlelibrary_domain_model_person_type.name',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim'
